...
func (m *MockUsecase) Execute(cep string) (usecase.OutputTempDTO, error) {
	args := m.Called(cep)
...
func TestGetTempByCep_SuccessfulResponse(t *testing.T) {
	...
	mockUsecase.On("Execute", "12345678").Return(usecase.OutputTempDTO{Temp_C: 25.0, Temp_F: 77.0, Temp_K: 298.0}, nil)
